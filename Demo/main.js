        ...
        function previewReport(fullUrlPath) {
            ...
            if (fullUrlPath.indexOf(".doc", 0) > -1 || fullUrlPath.indexOf(".docx", 0) > -1 || fullUrlPath.indexOf(".txt", 0) > -1 || fullUrlPath.indexOf(".xls", 0) > -1 || fullUrlPath.indexOf(".xlsx", 0) > -1 || fullUrlPath.indexOf(".csv", 0) > -1) {
                ...
                $.ajax({
                    ...
                    url: "/OfficeToHtml5Service/Service1.svc/getOfficeHtml5View",
                    dataType: "json",
                    ...
                    success: function (data) {
                        if (data.officeConverstionDataObj.convertedHtml5FileUrl !== null) {
                            ...
                            $("#myViewer").append("<div class='alert alert-block alert-danger' style='padding:5px;'>" + data.officeConverstionDataObj.error + "</div>");
                        }
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        $("#myViewer").append("<div class='alert alert-block alert-danger' style='padding:5px;'>Client request error:" + errorThrown + "</div>");
                    }

                });
            } else {
                $("#myViewer").empty();
                $("#myViewer").append("<div class='alert alert-block alert-danger' style='padding:5px;'>This file type can not be previewed.</div>");
            }
        }
    }
});
